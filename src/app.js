...
const friends = [
  { 
    username: 'joshhomme', 
    profilePictureUrl: "http://www.heightdb.com/sites/default/files/styles/entity_photo/public/field/image/Josh%20Homme%20Height_0.jpg?itok=woDG7l-4", 
    messages: ['Hey, whats up'], 
    isOnline: false
  },
  { 
    username: 'nickcave', 
    profilePictureUrl: "https://i0.wp.com/pleasekillme.com/wp-content/uploads/2015/11/FB_20151107_12_20_14_Saved_Picture1.jpg?resize=604%2C402", 
    messages: ['What do you want?'], 
    isOnline: false
  },
  { 
    username: 'kareno', 
...
const conversations = {
  "joshhomme": [
    { username: "joshhomme", text: "Hey, it's me. Josh." },
    { username: "stemmlerjs", text: "Hey man, what's up? How are you?" },
    { username: "joshhomme", text: "I'm good. I'm good. Anyways, listen. We're trying to get this new record going... I heard your album. Interested in being a part of the next QOTSA project?" },
    { username: "stemmlerjs", text: "Hmm, I'm kinda busy." },
    { username: "joshhomme", text: "Pls man." },
  ]
}
...
app.get('/api/friends/:username', function(req, res) {
  ...
  let messages = [];
  if (username) {
    friend = friends.filter((friend) => friend.username === username);
    if (friend.length === 1) {
      friend = friend[0];
    }
